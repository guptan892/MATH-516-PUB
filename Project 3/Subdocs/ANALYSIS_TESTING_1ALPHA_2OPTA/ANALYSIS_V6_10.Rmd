...
#export
png("OUTPUT_IMAGES_FROM_ANALYSIS_V6_10/causal_dag_rank_pc_method.png", width = 1200, height = 1000, res = 150)
...
bootstrap_results_rank_pc <- replicate(bootstrap_sample_size, {
  ...
  fit_boot <- pc(suffStat = suff_boot, indepTest = gaussCItest,
                    labels = colnames(boot_data), alpha = 0.10, verbose = FALSE)
...
png("OUTPUT_IMAGES_FROM_ANALYSIS_V6_10/consensus_dag_rank_pc_bootstrap.png", width = 1200, height = 1000, res = 150)
par(mar = c(1, 1, 3, 1)) 
...
#export
png("OUTPUT_IMAGES_FROM_ANALYSIS_V6_10/causal_dag_pc_method_test.png", width = 1200, height = 1000, res = 150)
...
#export
png("OUTPUT_IMAGES_FROM_ANALYSIS_V6_10/causal_dag_pc_method_v2_test.png", width = 1200, height = 1000, res = 150)
...
png("OUTPUT_IMAGES_FROM_ANALYSIS_V6_10/correlation_matrix_default_test.png", width = 1000, height = 1000, res = 150)
corrplot(cor(model.matrix(~.-1, data=pc_data)), method="circle")
dev.off()
```
...
png("OUTPUT_IMAGES_FROM_ANALYSIS_V6_10/causal_dag_pc_method_recentmonth_test.png", width = 1600, height = 1200, res = 150)
graphviz.plot(pc_fit_bnlearn, shape = "ellipse", 
     main = "TEST Full Causal DAG, PC Method")
# 3. Close the device to save the file
dev.off()
...
# # 2. Export a high-quality version
# png("OUTPUT_IMAGES_FROM_ANALYSIS_V6_10/causal_dag_pc_method_bnlearn_cextend.png", width = 1600, height = 1200, res = 150)
# graphviz.plot(pc_fit_cextend, shape = "ellipse", 
#      main = "Full Causal DAG, PC Method")
# # 3. Close the device to save the file
# dev.off()
...
# 2. Export a high-quality version
png("OUTPUT_IMAGES_FROM_ANALYSIS_V6_10/causal_dag_pc_method_bnlearn_maxsx_test.png", width = 1600, height = 1200, res = 150)
graphviz.plot(pc_fit_bnlearn_maxsx, shape = "ellipse", 
     main = "TEST Full Causal DAG, PC Method")
# 3. Close the device to save the file
dev.off()
...
# 2. Export a high-quality version
png("OUTPUT_IMAGES_FROM_ANALYSIS_V6_10/causal_dag_pc_method_bnlearn_cextend_maxsx_test.png", width = 1600, height = 1200, res = 150)
graphviz.plot(pc_fit_bnlearn_maxsx_cextend, shape = "ellipse", 
     main = "TEST Full Causal DAG, PC Method")
# 3. Close the device to save the file
dev.off()
...
# 2. Export a high-quality version
png("OUTPUT_IMAGES_FROM_ANALYSIS_V6_10/causal_dag_pc_method_bnlearn_limitedcov.png", width = 1600, height = 1200, res = 150)
graphviz.plot(pc_fit_bnlearn_limitedcov, shape = "ellipse", 
     main = "Causal DAG: PC Method, Limited Covariates")
# 3. Close the device to save the file
dev.off()
...
png("OUTPUT_IMAGES_FROM_ANALYSIS_V6_10/consensus_dag_pc_bootstrap_limitedcov.png", width = 1200, height = 1000, res = 150)
par(mar = c(1, 1, 3, 1)) 
plot(avg_graph_bootstrap_pc, 
     main = "Consensus DAG (Edges in >50% of Bootstraps): PC Method, Limited Covariates",
     vertex.size = 15,              # Smaller nodes
...
Use MMPC from bnlearn. The max-min parents and children algorithm. This searches the neighborhood of Y (parents and children) by testing for conditional independence at the alpha=0.10 level. Variable is only kept if relationship with Y can't be explained away by other variables.
...
local_y_test <- learn.mb(local_data_test_mbonly, node = "Y", method = "iamb", alpha = 0.10, test="cor")
...
local_a_test <- learn.mb(local_data_test_mbonly, node = "A", method = "iamb", alpha = 0.10, test="cor")
...
```{r}
# learn.mb(local_data, node = "A", method = "a", alpha = 0.10)
...
# Run nbr to find the markov blanket of Y only
local_y <- learn.mb(local_data_test_mbonly, node = "Y", method = "inter.iamb", alpha = 0.10, test = "cor")
...
#now do the same for A to get covariates for propensity score model
local_a <- learn.mb(local_data_test_mbonly, node = "A", method = "inter.iamb", alpha = 0.10, test = "cor")
print("Variables in the Local Neighborhood (Parents/Children) of A:")
print(local_a)
...
bootstrap_results_local <- replicate(bootstrap_sample_size, {
  ...
  local_y_boot <- tryCatch({
    learn.mb(sample_df_ranked, node = "Y", method = "inter.iamb", test = "cor", alpha = 0.10)
  }, error = function(e) character(0))
  
  cov_local_boot <- setdiff(local_y_boot, "A")
  
  local_a_boot <- tryCatch({
    learn.mb(sample_df_ranked, node = "A", method = "inter.iamb", test = "cor", alpha = 0.10)
  }, error = function(e) character(0))
...
# Run nbr to find the markov blanket of Y only
local_y_blacklist <- learn.mb(local_data, node = "Y", method = "inter.iamb", blacklist = master_blacklist_matrix_excl_y, alpha = 0.10)
...
#now do the same for A to get covariates for propensity score model
local_a_blacklist <- learn.mb(local_data, node = "A", method = "inter.iamb", blacklist = master_blacklist_matrix_excl_a, alpha = 0.10)
print("Variables in the Local Neighborhood (Parents/Children) of A:")
...
# 2. Export a high-quality version
png("OUTPUT_IMAGES_FROM_ANALYSIS_V6_10/causal_dag_pc_method_bnlearn_blacklist_test.png", width = 1600, height = 1200, res = 150)
graphviz.plot(pc_fit_bnlearn_blacklist, shape = "ellipse", 
     main = "TEST Full Causal DAG, PC Method")
# 3. Close the device to save the file
dev.off()
...
# 2. Export a high-quality version
png("OUTPUT_IMAGES_FROM_ANALYSIS_V6_10/causal_dag_pc_method_bnlearn_cextend_blacklist_test.png", width = 1600, height = 1200, res = 150)
graphviz.plot(pc_fit_bnlearn_cextend_blacklist, shape = "ellipse", 
     main = "TEST Full Causal DAG, PC Method")
# 3. Close the device to save the file
dev.off()
...
# 2. Export a high-quality version
png("OUTPUT_IMAGES_FROM_ANALYSIS_V6_10/causal_dag_pc_method_bnlearn_maxsx_blacklist_test.png", width = 1600, height = 1200, res = 150)
graphviz.plot(pc_fit_bnlearn_maxsx_blacklist, shape = "ellipse", 
     main = "TEST Full Causal DAG, PC Method")
# 3. Close the device to save the file
dev.off()
...
# 2. Export a high-quality version
png("OUTPUT_IMAGES_FROM_ANALYSIS_V6_10/causal_dag_pc_method_bnlearn_cextend_maxsx_blacklist_test.png", width = 1600, height = 1200, res = 150)
graphviz.plot(pc_fit_bnlearn_maxsx_cextend_blacklist, shape = "ellipse", 
     main = "TEST Full Causal DAG, PC Method")
# 3. Close the device to save the file
dev.off()
...
ggsave(filename = "OUTPUT_IMAGES_FROM_ANALYSIS_V6_10/ACE_Comparison_Table.png", 
       plot = tab_plot, 
...
# gtsave(final_table_img, filename = "OUTPUT_IMAGES_FROM_ANALYSIS_V6_10/ACE_Comparison_Table.png")
...
ggsave("OUTPUT_IMAGES_FROM_ANALYSIS_V6_10/ace_standard_errors.png", plot = ace_se_graph, width = 8, height = 6, dpi = 300)
print(ace_se_graph)
...
ggsave("OUTPUT_IMAGES_FROM_ANALYSIS_V6_10/ace_confidence_intervals.png", plot = ace_ci_graph, width = 8, height = 6, dpi = 300)
print(ace_ci_graph)
```
